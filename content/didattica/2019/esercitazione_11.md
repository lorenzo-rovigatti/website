...
1. La corrente che scorre nel filo alla sinistra dell'origine è uscente, mentre l'altra è entrante. I due fili genereranno, quindi, i seguenti campi magnetici lungo l'asse $x$:
\begin{align}
