...
La relazione matematica che riassume queste proprietà è la cosiddetta legge di Coulomb tramite qui possiamo scrivere l'espressione della forza che la carica $q_2$ in posizione $\vec{r}_2$ esercita sulla carica 1 in posizione $\vec{r}_1$:
