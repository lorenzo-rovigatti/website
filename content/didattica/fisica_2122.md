...
* **Scritto del 20/04/2022**:  L'esame scritto dell'appello straordinario si terrà (con alta probabilità) il giorno 20 aprile dalle ore 16 in aula G edificio di Chimica Cannizzaro (Vecchio edificio di Chimica). La data è spostata rispetto a quanto scritto in calendario per via della chiusura accademica legata alla Pasqua. Potrebbe succedere, se sarete troppi, che l'esame venga spostato in altro orario, sempre in questa giornata. Pertanto CONTROLLATE le email e/o il sito del corso e tenetevi liberi anche nella mattinata o nella serata più tardi. Gli orali si terranno nelle giornate del 21 e/o 22 Aprile o la settimana seguente (a seconda delle vostre esigenze). Dopo lo scritto farò calendario dettagliato, includendo anche coloro che hanno già superato l'esame scritto e si sono iscritti a questo appello. Lo scritto è aperto solo a coloro che hanno diritto agli appelli straordinari. L'orale è aperto anche a coloro che, in corso, hanno uno scritto valido. Gli scritti valgono 3 sessioni. Pertanto lo scritto di aprile resterà valido anche nelle sessioni di giugno e luglio. Questo appello rappresenta l'ultima data valida per fare l'orale con lo scritto superato a gennaio. L'iscrizione su INFOSTUD è obbligatoria. Ricordate di portare il formulario stampato all'esame scritto.
...
* Durante le prove d'esame non è consentito l'utilizzo di alcun libro o tipo di appunti ma solo del formulario che verrà fornito dal docente. Gli unici oggetti che possono essere visibili durante lo svolgimento di una prova scritta sono:
    ...
    * il ["bignami" del corso]({{< static "didattica/2021/formulario.pdf" >}})
